  ...
  async function checkUserType(userId: string) {
    try {
      ...
      if (customerDoc.exists()) {
         router.replace('/tabs/(auth)/loggedin/Profiles/Cutomer/CustomerProfile'); // Navigate to customer profile setup
        return;
      }
      ...
      if (restaurantDoc.exists()) {
        router.replace('/tabs/(auth)/loggedin/Profiles/Restaurant/RestaurantProfile'); // Navigate to restaurant profile setup
        return;
      }
